...
namespace Microsoft.R9.Extensions.MetricGenerator
{
    public partial class MetricGenerator
    {
        internal class Emitter
        {
            ...
            public string EmitMeterInterface(IReadOnlyList<MetricInstrumentClass> metricInstrumentClasses, CancellationToken cancellationToken)
            {
            ...
            public string EmitGenevaMeter(IReadOnlyList<MetricInstrumentClass> metricInstrumentClasses, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    foreach (var metricInstrumentClass in metricInstrumentClasses)
                    {
                        ...
                        // _ = sb.Append(GenGenevaMeter(metricInstrumentClass));
                    }
    ...
    {{
        ...
        public abstract partial class IMeter
        {{
            {sb}
        }}
    }}
    ";
            ...
            private string GenCreateMetricInterfaceEntries(MetricInstrumentMethod metricInstrumentMethod)
            {
                return $@"
            [global::System.Runtime.CompilerServices.CompilerGenerated]
            public abstract ICounterMetric<long> Create{metricInstrumentMethod.InstrumentClassType}
...
");
    ...
    ";
            ...
            private string GenGenevaMeter(MetricInstrumentClass metricInstrumentClass)
            {
                var sb = GetStringBuilder();
                try
                {
                    foreach (var metricInstrumentMethod in metricInstrumentClass.Methods)
                    {
                        _ = sb.Append(GenGenevaMeterMethods(metricInstrumentMethod));
                    }
    ...
    ";
            ...
            private string GenGenevaMeterMethods(MetricInstrumentMethod metricInstrumentMethod)
            {
                return $@"
            [global::System.Runtime.CompilerServices.CompilerGenerated]
            public ICounterMetric<long> Create{metricInstrumentMethod.InstrumentClassType}(string metricName, {GenRegularParameters(metricInstrumentMethod)})
                => _longCounterMetrics.GetOrAdd(
                    key: metricName,
                    value: _generatedCounterMetricFactory.Create{metricInstrumentMethod.InstrumentClassType}(metricName, {GenRegularParameters(metricInstrumentMethod, false)}));
";
            }
