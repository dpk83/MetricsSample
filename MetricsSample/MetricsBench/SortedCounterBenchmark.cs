...
namespace MetricsBench
{
    ...
    [MaxColumn]
    [MemoryDiagnoser]
    public class SortedCounterBenchmark
    {
        SortedDimensions dimensions = new SortedDimensions(new List<ValueTuple<string, string>>
            {
                new ("k1", "v1"),
                new ("k2", "v2"),
                new ("k3", "v3"),
        ...
        SortedDimensions dimensions2 = new SortedDimensions(new List<ValueTuple<string, string>>
            {
                new ("k1", "v1"),
                new ("k2", "v2"),
                new ("k3", "v31"),
        ...
        SortedDimensions changingDimensions = new SortedDimensions(new List<ValueTuple<string, string>>
            {
                new ("k1", "v1"),
                new ("k2", "v2"),
                new ("k3", "v3"),
        ...
        SortedDimensions dimensions20D = new SortedDimensions(new List<ValueTuple<string, string>>
            {
                new ("k1", "v11"),
                new ("k2", "v21"),
                new ("k3", "v31"),
        ...
        CounterMetricWithSortedDimensions counterMetric;
        CounterMetricWithSortedDimensions counterMetric20D;
        static int value1 = 0;
        static int value2 = 0;
        static ulong index = 0;

        public SortedCounterBenchmark()
        {
            counterMetric = new CounterMetricWithSortedDimensions(dimensions);
            counterMetric20D = new CounterMetricWithSortedDimensions(dimensions20D);
        }
