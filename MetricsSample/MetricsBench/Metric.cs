...
namespace MetricsBench
{
    public static partial class Metric
    {
        ...
        [Int64CounterMetric("RequestCounter", "env,host,region", "tenantId,requestName")]
        public static partial RequestCounter CreateRequestCounter(IMeter meter, string env, string host, string region);

        //[Int64ValueRecorderMetric("ValueRecorder5D", "k1,k2,k3,k4,k5")]
        //public static partial ValueRecorder5D CreateValueRecorder5D(IMeter meter, string k1, string k2, string k3, string k4, string k5);
    }
}
